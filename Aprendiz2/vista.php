...
<form action="SOSConexion.php" method="post"> 
	...
	<div class="form-group">
	<label>Tipo Documento del Aprendiz:</label>
    ...
    <div class="form-group">
	<label>Numero Documento del Aprendiz:</label>
	<select class="form-control" name="documentNumber">
	<?php
	foreach($db-> query('SELECT customer.documentNumber,customer_has_role.documentNumber,customer_has_role.roleId  FROM customer,customer_has_role where customer.documentNumber=customer_has_role.documentNumber and customer_has_role.roleId=4 ')as $row){
    ...
    <div class="form-group">
	<label>Numero Ficha a Asignar al Aprendiz:</label>
	...
	<div class="form-group">
	<label>Codigo Grupo a Asginar al aprendiz:</label>
	<select class="form-control" name="groupCode">
	<?php
	foreach($db-> query('SELECT * FROM projectGroup')as $row){

	
	echo '<option value="'.$row['groupCode'].'">'.$row['proyectName'].'-Pertenece a la Ficha-'.$row['fichaNumber'].'</option>';
