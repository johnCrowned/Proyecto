...
$row['programName'];
	...
	$row['programCode_version'];

	}
	if($row['programCode_version']=$r->_GET('programCode_version')){

echo $r->_GET('programCode_version').'-'.$row['programName'].'-'.$row['programCode_version'].'-'.$r->_GET('programName');
