...
if(isset($_REQUEST['action'])){
	...
	switch($_REQUEST['action']){
		...
		$usu -> _SET('description',                   $_REQUEST['description_Actualizar']);
...
<form action ="" method="post">
	...
	<div class="form-group" >
		...
		<input type="text" name="documentName" value="<?php echo $usu->_GET('documentName')?>" <?php echo $camposDesabilitados; ?> class="form-control" placeholder="Inserte Nombre Del Documento" required>
		<input type="hidden" name="documentName_Actualizar"  value="<?php echo $usu->_GET('documentName'); ?>">
	</div>

	<div class="form-group">
		<label>Descripción del Documento</label>
		<input type="text" name="description" value="<?php echo $usu->_GET('description')?>" <?php echo $camposDesabilitados; ?>  class="form-control" placeholder="Inserte la descripción del Documento." required>
		<input type="hidden" name="description_Actualizar"  value="<?php echo $usu->_GET('description')?>">
	</div>
